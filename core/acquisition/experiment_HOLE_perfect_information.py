...
def perfect_information_EI_UU_HOLE_function_caller_test(rep):
    ...
    for num_queries_idx in range(len(max_number_DMqueries)):
        ...
        for first_query_iteration_element in first_query_iteration[num_queries_idx]:
            folder = "RESULTS"
            subfolder = "HOLE_PI_EI_UU_n_queries_" + str(
                max_number_DMqueries[num_queries_idx]) + "_first_iteration_" + str(first_query_iteration_element)
            cwd = os.getcwd()
            ...
            AcquisitionwithDMInteration = AcquisitionFunctionandDecisionMakerInteraction(model=model_f, true_f=f,
                                                                                         acquisition_optimiser=acq_opt,
                                                                                         acquisition_f=EI_UU,
                                                                                         space=space, seed=rep,
